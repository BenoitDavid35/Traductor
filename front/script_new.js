...
$('#send-btn').on('click', function(e) {
  recognition.stop();
  console.log(JSON.stringify( { "text": $('#record_text').val(), "lang": getLanguage($(".chat__name").text())}))
  //on envoie la sauce
  var requestTranslateAndGetUrl = $.ajax({
      url: "http://vps696635.ovh.net:8081/file",
      dataType: 'json',
      type: 'post',
      contentType: 'application/json',
      data: JSON.stringify( { "text": $('#record_text').val(), "lang": getLanguage($(".chat__name").text())} ),
      processData: false,
  ...
  requestTranslateAndGetUrl.done(function(msg) {
    ...
    console.log(msg.url);
    $( "#list" ).append( "<div id='"+msg.id+"' class='chat__msgRow'><div class='chat__message mine'>"+msg.translation+"</div></div>");
    var audioElement = document.createElement('audio');
